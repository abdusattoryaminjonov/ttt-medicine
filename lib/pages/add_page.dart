...
class _AddPageState extends State<AddPage> {
  ...
  void initState() {
    ...
    controller.checkboxesController = GroupButtonController(
      ...
      onDisablePressed: (index) => ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('${controller.checkboxButtons[index]} is disabled')),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: GetBuilder<AddPageController>(builder: (_){
        return Stack(
          children: [
            SizedBox(
              height:200,
                        ...
                        child: Column(
                          ...
                          children: [
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child:  TextField(
                                          controller: controller.overallNumberTextController,
                            ...
                            GroupButton(
                              ...
                              buttons: controller.checkboxButtons.keys.toList(), // Faqat kalitlar ro'yxati
                              buttonIndexedBuilder: (selected, index, context) {
                                String title = controller.checkboxButtons.keys.elementAt(index);
                                String initialTime = controller.checkboxButtons[title]!;
                                  ...
                                  children: [
                                    Expanded(
                                      child: CheckBoxTile(
                                        ...
                                        onTap: () {
                                          if (!selected) {
                                            controller.checkboxesController.selectIndex(index);
                                            return;
                                          }
                                          controller.checkboxesController.unselectIndex(index);
                                        },
                                      ),
                                    ),
                                    Expanded(
